...
1.  <span id="Q_001" style="color:White">Closest distance to a parabola.</span> 
    ...
    - <canvas id="cv_001" style="width:512px;height:512px;margin:auto;display: block;"><textarea id="answer_text"></textarea><input type="checkbox" id="answer_check"><canvas>
    - Answer: <div id="answer_001" style="width:100%;height:800px">
        <input type="checkbox" id="answer_check">
        <button id="btn_001"  onclick="_shader_btn_click(this.id)">run</button>
        </div>
